...
//        }
        ...
        // Throw it out and put in the dx/dy
        mouseReport.x = constrain(dx, -127,127);
        mouseReport.y = constrain(dy, -127,127);
        mouseReport.buttons.button1 = leftCounter > THRESH; // left
        mouseReport.buttons.button2 = rightCounter > THRESH; // right
        mouseReport.buttons.button3 = midCounter > THRESH; // mid
